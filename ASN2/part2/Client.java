...
public class Client {
    public static void main(String[] args) {
        ...
        computerPartyOrder.addItem(motherboard.next());
        computerPartyOrder.addItem(ram.next());
        computerPartyOrder.addItem(drive.next());
        computerPartyOrder.addItem(printer.next());
        computerPartyOrder.addItem(monitor.next());
        computerPartyOrder.addItem(assemblyService.next());
        computerPartyOrder.addItem(deliveryService.next());
        computerPartyOrder.addItem(cheddar.next());
        computerPartyOrder.addItem(mozzarella.next());
        computerPartyOrder.addItem(apple.next());
        computerPartyOrder.addItem(orange.next());
